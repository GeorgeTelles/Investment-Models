...
for ativo in ativos:
    try:
        ...
        for index, row in rates_frame.iterrows():
            ...
            elif position == 1 and (row['Sell_Signal'] or (row['close'] - entry_price) <= stop_loss):
                position = 0
        ...
        performance_metrics.append({
            ...
            'Retorno médio por op': average_profit_per_trade,
...
performance_df.to_excel(f"RSI_Indice_{RSI_ENTRADA}_{RSI_SAIDA}_SL25_M1.xlsx", index=False)
