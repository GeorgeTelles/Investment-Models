...
df_empresas = pd.read_excel(r'C:\Users\George Telles\Desktop\acoesfiltradas.xlsx', header=0, usecols="A")
...
performance_df.to_excel(f"IFR2_SMA_{PERIODO_MM}_RSI_{RSI_ENTRADA}_{RSI_SAIDA}_M5.xlsx", index=False)
