...
print(f"Qtd de operações: {total_trades}")
...
print(f"Média de ganho: {average_gain * 100:.2f}%")
print(f"Média de perda: {average_loss * 100:.2f}%")
print(f"Retorno médio: {average_profit_per_trade * 100:.2f}%")
print(f"Retorno Buy and Hold: {buy_and_hold_return:.2f}%")
...
trade_records_df.to_excel(f"Operações_RSI22_{ativo}.xlsx")
