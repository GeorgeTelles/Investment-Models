...
for ativo in ativos:
    try:
        ...
        rates_frame['SMA'] = ta.trend.sma_indicator(rates_frame['close'], window=PERIODO, fillna=False)

        rates_frame['Buy_Signal'] = (rates_frame['close'] > rates_frame['SMA'])
        ...
        performance_metrics.append({
            ...
            'Média de ganho por op': average_gain,
            'Média de perda por op': average_loss,
...
performance_df.to_excel(f"SMA_{PERIODO}_INTRA_INDICE_M1.xlsx", index=False)
