...
stop_loss = -0.005  # Exemplo: stop loss de 2%
...
for ativo in ativos:
    try:
        ...
        rates_frame['Buy_Signal'] = (rates_frame['close'] > rates_frame['EMA_1']) & (rates_frame['close'] > rates_frame['EMA_2'])
        rates_frame['Sell_Signal'] = (rates_frame['close'] < rates_frame['EMA_1'])
...
performance_df.to_excel(f"CRUZAMENTO_MM_{PERIODO_MM1}_{PERIODO_MM2}_STOP_05_{time_frame}_2023_1.xlsx", index=False)
