...
for ativo in ativos:
    try:
        ...
        rates_frame['Buy_Signal'] = (rates_frame['L_BAND'] == 1)
        #rates_frame['Buy_Signal'] = (rates_frame['Close'] < rates_frame['M_BAND'])
        rates_frame['Sell_Signal'] = (rates_frame['H_BAND'] == 1)
...
performance_df.to_excel(f"BANDA DE BOLLINGER_{PERIODO_BB}_H1.xlsx", index=False)
